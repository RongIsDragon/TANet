...
class DANetHead(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.bottleneck = nn.Sequential(
            nn.Conv2d(inter_channels * 3, out_channels, kernel_size=3, padding=1, dilation=1, bias=False),
    ...
    def forward(self, x):
        ...
        output = self.bottleneck(torch.cat([sasc_output, sa_output, sc_output], 1))
